                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route("admin.page.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mt-2">
                                        <label for="name" class=""> Button Text2*</label>
                                        <input type="text"  name="button_text2" class="form-control @error('button_text') is-invalid @enderror" value="{{ empty(old('button_text2')) ? ((isset($page) && !empty($content['hero'])) ? $content['hero']['button_text2'] : '') : old('button_text2') }}" required>
                                        @error('button_text')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6 mt-2">
                                        <label for="name" class=""> Button Link2 *</label>
                                        <input type="url"  name="button_link2" class="form-control @error('button_link') is-invalid @enderror" value="{{ empty(old('button_link2')) ? ((isset($page) && !empty($content['hero'])) ? $content['hero']['button_link2'] : '') : old('button_link2') }}" required>
                                        @error('button_link')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
