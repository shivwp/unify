...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.projects.update", [$project->id]) }}" method="POST" enctype="multipart/form-data" id="formId">
            ...
            <div class="form-group {{ $errors->has('budget') ? 'has-error' : '' }} mt-3 per_hour_budget" id="per_hour_budget" {{ old('budget') ? (old('budget') == 'hourly' ? '' : 'style=display:none;' ) : (isset($project) ? (($project->budget_type == 'hourly') ? '' : 'style=display:none;' ) : 'style="display: none;"' ) }} >
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="form-group {{ $errors->has('budget') ? 'has-error' : '' }} mt-3 total_budget" id="total_budget" {{ old('budget') ? (old('budget') == 'fixed' ? '' : 'style=display:none;' ) : (isset($project) ? (($project->budget_type == 'fixed') ? '' : 'style=display:none;' ) : 'style="display: none;"' ) }}>
                <label for="budget">Maximum</label>
            ...
            @if(!empty($project->project_images))
                <div class="parc">
                    <img src="{{ url('/project-files').'/'.$project->project_images ?? "" }}" alt="" width="100" height="100">
                </div>
            @endif
