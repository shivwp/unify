                    ...
                    <div class="card-body">
                        <form action="{{ route("admin.projects.store") }}" method="POST" enctype="multipart/form-data" id="formId">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('budget') ? 'has-error' : '' }} mt-3 per_hour_budget" id="per_hour_budget" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-6">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('budget') ? 'has-error' : '' }} mt-3 total_budget" id="total_budget" style="display: none;">
                                    <label for="budget">Maximum in ($)</label>
