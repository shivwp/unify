        ...
        <div class="row">
            <div class="row tabelhed d-flex justify-content-between">
                <div class="col-lg-2 col-md-2 col-sm-2 d-flex">
                    ...
                    <a class="btn-sm ad-btn btn text-center pt-2 create_btn" href="{{ route('admin.specialization.create') }}"> Add</a>
                            ...
                            <tbody>
                                ...
                                @foreach($specialization as $key => $value)
                                    <tr data-entry-id="{{ $value->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('admin.specialization.edit', $value->id) }}">
                                            ...
                                            <form action="{{ route('admin.specialization.destroy', $value->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
