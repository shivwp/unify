            ...
            <div class="col-lg-12">
                <div class="row tabelhed d-flex justify-content-between">
                    <div class="col-lg-2 col-md-2 col-sm-2 d-flex">
                        <a class="btn-sm ad-btn create_btn text-center pt-2" href="{{ route("admin.hours-per-week.create") }}"> Add</a>
                                    ...
                                    @foreach($hours as $key => $value)
                                        <tr data-entry-id="{{ $value->id }}">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.hours-per-week.destroy', $value->id) }}" method="POST" style="display: inline-block;">
