        ...
        <div class="row ">
                ...
                <div class="row tabelhed d-flex justify-content-between">
                    <div class="col-lg-2 col-md-2 col-sm-2 d-flex">
                        @can('user_create')
                        <a class="btn-sm ad-btn text-center pt-2" href="{{ route('admin.project-category.sub_category_create',$parent_id) }}"> Add</a>
                        @endcan
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 "> 
                        ...
                        <div class="right-item" >
                            <form action="" class="d-flex" method="get">
                                ...
                                <a href="{{url('admin/project-sub-category', $parent_id)}}">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-6">  
                                <h5 class="m-0 mb-1">Sub-Category List</h5>
                            </div>
                            <div class="col-lg-6">  
                    ...
                    <div class="card-body">
                        <div class="table">
                            <table class=" table table-bordered table-striped table-hover datatable datatable-ProjectStatus example">
                                ...
                                <tbody>
                                @php $i=1 @endphp
                                    @foreach($projectsubCategory as $key => $projectCate)
