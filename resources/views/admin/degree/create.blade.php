                    ...
                    <div class="card-body">
                        <form action="{{ route("admin.degree.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ empty(old('title')) ? (isset($degree) ? $degree->title : '') : old('title') }}" required>
                                @error('title')
