            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header border-bottom">
                       <h5> {{ trans('global.create') }} New {{ trans('cruds.user.title_singular') }}</h5>
                    </div>
                    @php
                        ...
                        <form action="{{ route("admin.users.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('last_name') ? 'has-error' : '' }} mt-2">
                                    <label for="name" class="mt-2">Last name *</label>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('password') ? 'has-error' : '' }}">
                                    ...
                                    <input type="password" id="password" name="password" min="8" class="form-control @error('password') is-invalid @enderror" required>
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                               ...
                               <div class="form-group col-md-6 {{ $errors->has('referal_code') ? 'has-error' : '' }}">
