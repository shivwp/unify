            ...
            <div class="col-lg-12">
                <div class="row tabelhed d-flex justify-content-between" style="height: 91px">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pl-2 row d-flex justify-content-end">
                        <div class="col-md-3" style="width: 192px; margin-right: 150px">
                            <?php 
                           ...
                           ?>
                            <form action="" method="get" id="status_filter_form">
                                <select class="form-control" id="project_status_filter" style="text-align: center;" name="project_status_filter">
                        ...
                        <div class="col-md-5">
                            <form action="" method="GET" style="float: right;" class="d-flex">
                              ...
                              ?>
                                ...
                                <div class="mb-3">
                                  <input type="text" style="width: 310px" value="{{$Search}}" name="keyword" class="form-control" placeholder="Name or Email">
                                </div>
