            ...
            <div class="col-lg-12">
                <div class="row tabelhed d-flex justify-content-between">
                    <div class="col-lg-2 col-md-2 col-sm-2 d-flex">
                        <a class="btn-sm ad-btn create_btn text-center pt-2" href="{{ route("admin.dislike-reason.create") }}"> Add</a>
                                    ...
                                    @foreach($reason as $key => $value)
                                        <tr data-entry-id="{{ $value->id }}">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.dislike-reason.destroy', $value->id) }}" method="POST" style="display: inline-block;">
