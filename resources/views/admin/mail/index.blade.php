...
<style type="text/css">
   ...
   border-radius: 8px;
   height: 39px; width: 37px; margin-right:2px
   }
   .s-input{
    margin-left: 80px
   }
...
<!-- Content -->
   <div class="container-xxl flex-grow-1 container-p-y">
      <div class="row">
         <div class="col-lg-12">
            <div class="row tabelhed d-flex justify-content-between" style="height: 91px">
               <div class="col-lg-2 col-md-2 col-sm-2 d-flex">
                  @can('project_create')
                  <a class="btn-sm ad-btn text-center create_btn pt-2" href="{{ route('admin.mail.create') }}">
                  Add Mail
                  </a>
                  @endcan
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 pl-2">
                  <form action="" method="GET" class="d-flex">
                             <input type="text" class="form-control s-input" name="search" value="{{$search}}" placeholder="Search.." value="">
                     <div class="d-flex" style="margin-left: 5px;">
                        ...
                        <a href="{{url('admin/mail')}}" style="margin-left: 5px">
            ...
            <div class="card">
               ...
               <a  href="{{ route('admin.mail.edit', $item->id) }}">
                ...
                <form action="{{ route('admin.mail.destroy', $item->id) }}" method="POST" style="display: inline-block;">
