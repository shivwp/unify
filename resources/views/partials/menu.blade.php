    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('project_access')
                    <li class="nav-item has-treeview {{ request()->is('admin/projects*') ? 'menu-open' : '' }} {{ request()->is('admin/project-category*') ? 'menu-open' : '' }} {{ request()->is('admin/project-skill*') ? 'menu-open' : '' }} {{ request()->is('admin/project-listing-type*') ? 'menu-open' : '' }} {{ request()->is('admin/project-statuses*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('project_category_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.project-category.index") }}" class="nav-link {{ request()->is('admin/project-category') || request()->is('admin/project-category/*') ? 'active' : '' }}">
                                        <i class="fa-fw fa fa-newspaper">
                            ...
                            @can('project_skills_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.project-skill.index") }}" class="nav-link {{ request()->is('admin/project-skill') || request()->is('admin/project-skill/*') ? 'active' : '' }}">
                                        <i class="fa-fw fa fa-tasks">
                            ...
                            @can('project_listing_type_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.project-listing-type.index") }}" class="nav-link {{ request()->is('admin/project-listing-type') || request()->is('admin/project-listing-type/*') ? 'active' : '' }}">
                                        <i class="fa-fw fa fa-list">
                ...
                @can('client_management_setting_access')
                    <li class="nav-item has-treeview {{ request()->is('admin/currencies*') ? 'menu-open' : '' }} {{ request()->is('admin/transaction-types*') ? 'menu-open' : '' }} {{ request()->is('admin/income-sources*') ? 'menu-open' : '' }} {{ request()->is('admin/client-statuses*') ? 'menu-open' : '' }} ">
                        <a class="nav-link nav-dropdown-toggle" href="#">
